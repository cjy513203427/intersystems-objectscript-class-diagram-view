...
import { ServerClassInfo } from '../service/types';
import { RestClassService } from '../service/restClassService';

/**
 * REST API-based database query generator
 */
export class RestDatabaseQueryGenerator {
    public classService: RestClassService;
    private outputChannel: vscode.OutputChannel;

    constructor() {
        this.classService = new RestClassService();
        this.outputChannel = vscode.window.createOutputChannel('InterSystems Class Diagram REST SQL');
